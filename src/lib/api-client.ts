...
class ApiClient {
    ...
    async checkUserId(userId: string) {
        return this.request("/auth/check-user-id", {
            method: "POST",
            body: JSON.stringify({ userId }),
        });
    }
    async checkNickname(nickname: string) {
        return this.request("/auth/check-nickname", {
            method: "POST",
    ...
    async generateDiet(prompt: string, saveToDatabase = false) {
        return this.request("/ai/generate-diet", {
            method: "POST",
            body: JSON.stringify({ prompt, saveToDatabase }),
        });
    }
