    ...
    try {
        ...
        const updatedWorkout = await prisma.savedWorkout.update({
            ...
            data: {
                ...
                duration,
                intensity,
                targetMuscles: targetMuscles ? JSON.stringify(targetMuscles) : null,
        ...
        const parsedWorkout = {
            ...updatedWorkout,
            targetMuscles: updatedWorkout.targetMuscles ? JSON.parse(updatedWorkout.targetMuscles) : [],
            exercises: updatedWorkout.exercises ? JSON.parse(updatedWorkout.exercises) : []
        }
